...
/***
 * Classe controller da tela exibir todos os discos do banco de dados.
 *
...
public class ExibirTipoDiscoController extends MenuController{
    ...
    /**
     * Método para realizar a busca por todos os objetos tipo Disco no banco de dados.
     * Cria um ArrayList do tipo Disco, chama o método exibirProdutosDisco() pertencente à classe
     * Operacoes e armazena seu retorno ao array list.
     * Caso não haja produtos com essa especificação, exibe mensagem de que não existem discos cadastrados.
