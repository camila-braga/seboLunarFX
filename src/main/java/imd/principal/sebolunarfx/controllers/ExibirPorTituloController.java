...
/***
 * Classe controller da tela exibir produtos por título.
 *
...
public class ExibirPorTituloController extends MenuController{
    ...
    /**
     * Método para realizar a busca por objetos que possuam o mesmo título.
     * Faz a leitura do campo de preenchimento, cria um ArrayList do tipo Produto, chama
     * o método exibirPorTitulo(String titulo) pertencente à classe Operacoes e armazena seu retorno ao array
